...
- One spec file per class/module. For each class or module under `lib/`, keep all of its unit tests in a single spec file under `spec/` that mirrors the path and file name exactly: `lib/kettle/ndjson/my_class.rb` -> `spec/kettle/ndjson/my_class_spec.rb`.
...
Also see GitLab Contributors: [https://gitlab.com/TODO: Put your gem's public repo URL here./-/graphs/main][🚎contributors-gl]
...
[🧪build]: TODO: Put your gem's public repo URL here./actions
